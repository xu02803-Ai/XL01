      ...
      <div className="flex flex-col sm:flex-row h-full">
        ...
        <div className="sm:w-1/3 h-48 sm:h-auto min-h-[200px] relative bg-slate-100 dark:bg-black/40 overflow-hidden group-hover:brightness-110 transition-all">
          {loadingImg ? (
            ...
            <div className="absolute inset-0 flex items-center justify-center text-slate-400 dark:text-slate-600 bg-gradient-to-br from-slate-200 to-slate-300 dark:from-slate-800 dark:to-slate-900">
